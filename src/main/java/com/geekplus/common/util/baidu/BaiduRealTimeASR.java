package com.geekplus.common.util.baidu;///**
// * author     : geekplus
// * email      : geekcjj@gmail.com
// * date       : 3/1/23 23:43
// * description: 做什么的？
// */
//package com.maike.common.utils.baiduai;
//
...
// * STEP 3. 关闭连接
// */
//public class BaiduRealTimeASR {
//    // 先修改Const里的鉴权参数
//
//
//    private static Logger logger = Logger.getLogger("BaiduRealTimeASR");
//
...
//        new BaiduRealTimeASR(filename).run();
//
//    }
//
//    private BaiduRealTimeASR(String filename) {
...
//    }
//
//    public BaiduRealTimeASR(InputStream inputStream) {
...
//
//            params.put("appid", RTASRConst.APPID);
//            params.put("appkey", RTASRConst.APPKEY);
//
//            params.put("dev_pid", RTASRConst.DEV_PID);
...
//            int bytesPerFrame = RTASRWSUtil.BYTES_PER_FRAME; // 一个帧 160ms的音频数据
//            byte[] buffer = new byte[bytesPerFrame];
//            int readSize;
//            long nextFrameSendTime = System.currentTimeMillis();
//            do {
//                // 数据帧之间需要有间隔时间， 间隔时间为上一帧的音频长度
//                RTASRWSUtil.sleep(nextFrameSendTime - System.currentTimeMillis());
//                try {
...
//                    nextFrameSendTime = System.currentTimeMillis() + RTASRWSUtil.bytesToTime(readSize);
//                    logger.finer("should wait to send next DATA Frame: " + RTASRWSUtil.bytesToTime(readSize)
