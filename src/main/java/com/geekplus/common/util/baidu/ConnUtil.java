...
public class ConnUtil {
     ...
     */
    public static String getResponseString(HttpURLConnection conn) throws IOException, BaseException {
    ...
    public static byte[] getResponseBytes(HttpURLConnection conn) throws IOException, BaseException {
        ...
        if (responseCode != 200) {
            ...
            throw new BaseException("http response code is" + responseCode);
        }
