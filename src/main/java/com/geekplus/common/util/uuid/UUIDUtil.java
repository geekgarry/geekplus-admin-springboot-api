...
public final class UUIDUtil implements java.io.Serializable, Comparable<UUIDUtil>
{
    ...
    {
        return randomUUID(true).toString();
    }
     ...
     * @return 随机UUID
     */
    public static String fastUUIDStr()
    {
        return randomUUID(false).toString();
    }
    ...
    {
        return randomUUID(false).toString(true);
    }

    /**
     * 获得主键ֵ target+uuid+timestamp
     * @param target  null 默认 GeekPlus
     * @return 128 位加密
     */
    public static String getBase64UUID(String target){
        if(null == target){
            target = Constant.APP_MAIN_ID_KEY;
        }
     ...
     * @return 128 位加密
     */
    public static String getShaUUID(String target){
        if(null == target){
            target = Constant.APP_MAIN_ID_KEY;
        }
        StringBuffer sb = new StringBuffer();
     ...
     * @return 128 位加密
     */
    public static String getMd5UUID(String target){
        if(null == target){
            target = Constant.APP_MAIN_ID_KEY;
        }
        StringBuffer sb = new StringBuffer();
        ...
        sb.append(fastUUIDStr());
        sb.append(new Date().getTime());
        return EncryptUtil.md5Hex(sb.toString());
    }
    ...
    public static String getUUIDTimeStamp(){
        String uuid = UUID.randomUUID().toString().replaceAll("-", "")+new Date().getTime();
        return uuid;
    }
}
